...
#fUNCTIONS TO COMMUNICATE WITH THE BACKEND API AND THE SENTIMENT MICROSERVIES


#get_dealerships it will use th get_request defined in the restapis.py and communicate with backend api 
